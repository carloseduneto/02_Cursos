'''
1. Voos internacionais do aeroporto de Logan em 2014
2. Quando ocorreu maior transito de passageiros
3. Total de passageiros no ano especificado pelo usuário
4. Qual mês possui maior média diária de um hotel
'''

with open("economic-indicators.csv", "r") as boston:
    #Abre modo leitura
    total=0#Armazena o total de voos
    for linha in boston.readlines()[1:-1]: #Percorre tudo exceto alinha zero (títulos), e verifica
